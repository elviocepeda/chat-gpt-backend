export const forgotPasswordTemplate = (url, username) => {
  return `
    <!DOCTYPE html>
  ...
  <h1 style="margin: 0; color: #555555; font-size: 23px; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; line-height: 120%; text-align: center; direction: ltr; font-weight: 700; letter-spacing: normal; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder">- CHAT AI: Hola ${username}! -</span></h1>
  </td>
  </tr>
  </table>
  ...
  <p style="margin: 0;">¡Click para reestablecer tu contraseña!</p>
  </div>
  </td>
  </tr>
  </table>
